...
VALUES
     ('Gluten', '', 'Zhan', 1, NULL, SYSDATE(6), SYSDATE(6))
    ,('Pinda', '', 'Pinda', 1, NULL, SYSDATE(6), SYSDATE(6))
    ,('Noten', '', 'Noten', 1, NULL, SYSDATE(6), SYSDATE(6))
    ,('Gluten', '', 'Gluten', 1, NULL, SYSDATE  (6), SYSDATE(6))
    ,('Lactose', '', 'Lactose', 1, NULL, SYSDATE(6), SYSDATE(6))
    ,('Schaaldieren', '', 'Schaaldieren', 1, NULL   , SYSDATE(6), SYSDATE(6))
