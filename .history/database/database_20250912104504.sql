...
VALUES
    ...
    ,('Noten', '', 'Dit product bevat AZO-kleurstoffen', 1, NULL, SYSDATE(6), SYSDATE(6))
    ,('Gluten', '', 'Dit product bevat lactose', 1, NULL, SYSDATE  (6), SYSDATE(6))
    ,('Lactose', '', 'Dit product bevat soja', 1, NULL, SYSDATE(6), SYSDATE(6))
